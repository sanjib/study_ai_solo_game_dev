...
## Samurai Toad
Created using Unreal Engine. The game does not have any animation. Static poses indicate idle, victory and defeat states. 
...
## Ontology Case Study of Stardew Valle
Created using ontologies based on RDF file format. Protege software is used for easily and visually creating ontologies. An example thin slice of the gifting subsystem of the game Stardew Valley was created as an example how such AI systems and models can be used for game development. 
